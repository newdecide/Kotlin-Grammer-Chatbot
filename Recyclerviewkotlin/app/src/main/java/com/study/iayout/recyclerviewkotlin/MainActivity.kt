package com.study.iayout.recyclerviewkotlin
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kotlinrecycler.adapter = MainRecyclerViewAdapter()
        var gridManager = GridLayoutManager(this, 3)
        kotlinrecycler.layoutManager = gridManager
    ...
    class MainRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        class CustomViewHolder(view: View?) : RecyclerView.ViewHolder(view!!) {
            ...
            init {
                imageview = view!!.findViewById(R.id.kotlinimage)
            }
        }
